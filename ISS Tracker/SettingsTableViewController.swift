...
class SettingsTableViewController: UITableViewController {
    ...
    @IBOutlet private weak var pulseSwitch: UISwitch!
    ...
    @IBOutlet private weak var numberOfDaysOfPasses: UISegmentedControl! {          // Set up segment labels from dictionary
        didSet{
    ...
    @IBAction func pulsingEnabled(_ sender: UISwitch) {
        if sender.isOn {
            Globals.pulsingEnabled = true
        } else {
            Globals.pulsingEnabled = false
        }
    }
