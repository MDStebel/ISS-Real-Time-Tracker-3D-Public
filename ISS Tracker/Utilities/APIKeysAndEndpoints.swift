...
struct ApiEndpoints {
    ...
    static let crewAPIEndpointTest       = "https://issrttapi.com/crew-test.json"
    ...
    static let issTrackerAPIEndpointA    = "https://api.wheretheiss.at/v1/satellites/"
    ...
    static let ratingURL                 = "itms-apps://itunes.apple.com/app/id1079990061?action=write-review"
