...
//  Copyright © 2018-2025 ISS Real-Time Tracker. All rights reserved.
//
...
struct UserGuide {
    ...
    <li><h6>Marker pulsing is enabled by default.</h6></li>
    <li><h6>To enable/disable pulsing, go to Settings.</h6></li>
