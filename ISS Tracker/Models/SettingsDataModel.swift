...
struct SettingsDataModel {
    ...
    static func saveUserSettings() {
        ...
        if Globals.autoRotateGlobeEnabled {
            defaults.set(true, forKey: UserSettingsPropertyKeys.autoRotateGlobeKey)
        } else {
            defaults.set(false, forKey: UserSettingsPropertyKeys.autoRotateGlobeKey)
        }
        
        if Globals.pulsingEnabled {
            defaults.set(true, forKey: UserSettingsPropertyKeys.pulsingEnabledKey)
        } else {
            defaults.set(false, forKey: UserSettingsPropertyKeys.pulsingEnabledKey)
        }
    ...
    static func restoreUserSettings() {
        ...
        if defaults.object(forKey: UserSettingsPropertyKeys.autoRotateGlobeKey) != nil {
            Globals.autoRotateGlobeEnabled = defaults.bool(forKey: UserSettingsPropertyKeys.autoRotateGlobeKey)
        }
        
        if defaults.object(forKey: UserSettingsPropertyKeys.pulsingEnabledKey) != nil {
            Globals.pulsingEnabled = defaults.bool(forKey: UserSettingsPropertyKeys.pulsingEnabledKey)
        }
