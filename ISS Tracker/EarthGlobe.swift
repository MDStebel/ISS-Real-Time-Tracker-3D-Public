...
final class EarthGlobe: ObservableObject {
    ...
    let ambientLightIntensity              = Globals.ambientLightIntensity        // Default value is is set in Globals in lumens units
    ...
    init() {
        ...
        /// OpenGL fragment shader modifier (lighting map) in C++ code creates our emitter texture
        let shaderModifier               = """
